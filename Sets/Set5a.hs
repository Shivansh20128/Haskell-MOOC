...
buyOneMore (MkShoppingEntry x price count) = MkShoppingEntry x price (count+1)
...
data Person = PersonMaker String Int
  deriving Show

-- fred is a person whose name is Fred and age is 90
fred :: Person
fred = PersonMaker "Fred" 90

-- getName returns the name of the person
getName :: Person -> String
getName (PersonMaker name age) = name

-- getAge returns the age of the person
getAge :: Person -> Int
getAge (PersonMaker name age) = age

-- setName takes a person and returns a new person with the name changed
setName :: String -> Person -> Person
setName name (PersonMaker name1 age) = (PersonMaker name age)

-- setAge does likewise for age
setAge :: Int -> Person -> Person
setAge age (PersonMaker name age1) = (PersonMaker name age)
------------------------------------------------------------------------------
