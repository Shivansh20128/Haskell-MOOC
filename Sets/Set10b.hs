...
boolLength :: [Bool] -> Int
boolLength [] = 0
boolLength (True : listBooleans) = boolLength listBooleans + 1
boolLength (False : listBooleans) = boolLength listBooleans + 1
...
instance MySeq Bool where
  myseq False answer = answer
  myseq True answer = answer

instance MySeq Int where
  myseq 0 answer = answer
  myseq _ answer = answer
